        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-6">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-semibold text-slate-900 shadow-xs hover:bg-slate-50 hover:border-slate-300"
            >
              ...
              {activeLab?.isOwner && (
                <span className="rounded-md bg-slate-100 px-1.5 py-0.5 text-[10px] font-bold text-slate-800 border border-slate-200">
                  Owner
                </span>
              )}
              <svg
              ...
              <div className="absolute left-0 z-30 mt-1.5 w-64 rounded-xl border border-slate-200 bg-white py-1 shadow-lg ring-1 ring-black/5">
                  ...
                  {labs.map((lab) => (
                    <button
                      ...
                      className={`flex w-full items-center justify-between px-3 py-2 text-left text-xs transition-colors hover:bg-slate-50 ${
                        activeLab?.id === lab.id ? "bg-slate-100 font-bold text-slate-950" : "text-slate-700"
                      }`}
                    >
                      ...
                      {activeLab?.id === lab.id && (
                        <svg className="h-4 w-4 shrink-0 text-slate-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="border-t border-slate-100 p-1">
                  <button
                    ...
                    className="flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-xs font-semibold text-slate-900 hover:bg-slate-100"
                  >
            ...
            <form onSubmit={handleCreateLabSubmit} className="mt-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full rounded-xl border border-slate-200 px-3.5 py-2 text-sm text-slate-900 outline-hidden focus:border-slate-900 focus:ring-1 focus:ring-slate-900"
                />
              </div>
              <div>
