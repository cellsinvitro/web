      ...
      <section className="bg-white pt-24 pb-16 sm:pb-20 lg:pb-24">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            {/* Whole Library Pass Banner Button */}
            {!loading && libraryPrice > 0 && !hasFullAccess ? (
              <div className="rounded-2xl border border-amber-200 bg-amber-50/70 p-5 shadow-sm md:w-80">
                ...
                <p className="mt-1 text-xs text-slate-600">
                  Get instant access to all current and future research modules.
                </p>
                <div className="mt-4">
