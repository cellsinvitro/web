...
export default function LiveClassesPage() {
  ...
  return <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8">
    {paying && <GlobalLoader fullScreen label="CellsInVitro" sublabel="Processing payment..." showProgressBar={false} />}
